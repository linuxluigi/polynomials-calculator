...
public class Main {
    public static void main(String[] args) {
        ...
        if (FileName != PolynomialList.get_FileName()) {
        ...
        if ("n" != Question_LoadJsonM || "N" != Question_LoadJsonM) {
            PolynomialList.load();
        }
    ...
    private static void MainMenu(){
        ...
        switch (choice) {
            ...
            case 3:
                // Polynom bearbeiten
                // todo add Polynom bearbeiten funktion
                break;
            case 4:
                // Polynom löschen
    ...
    private static void MainMenu_DeletePolynomial() {
        ...
        if ("y" == Question_Delete && "Y" == Question_Delete) {
